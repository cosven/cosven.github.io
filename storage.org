...
把 blocksize 改正常值 IOPS，改大可以测带宽。
#+BEIGN_SRC shell
fio --filename=/data1/test_fio -iodepth=64 -ioengine=libaio -direct=1 \
  -rw=randwrite -bs=4k -size=100G -numjobs=128 -runtime=300 -group_reporting \
  -name=test-rand-writ
#+END_SRC
